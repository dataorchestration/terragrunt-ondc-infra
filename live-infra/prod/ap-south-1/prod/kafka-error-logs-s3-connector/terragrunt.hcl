...
inputs = {
  ...
  kafka_bootstrap_servers    = "b-3.ondcevents.mrk1bz.c2.kafka.ap-south-1.amazonaws.com:9092,b-1.ondcevents.mrk1bz.c2.kafka.ap-south-1.amazonaws.com:9092,b-2.ondcevents.mrk1bz.c2.kafka.ap-south-1.amazonaws.com:9092"
  ...
  connector_name       = "s3-kafka-error-logs-connector"
  cloudwatch_log_group = "s3-kafka-error-logs-connector"
  name = "s3-kafka-error-logs"
  ...
  map_of_connector_configuration               = tomap({
    ...
    "tasks.max"                   = "1"
    "topics.regex"                = "ondc_error_logging_.*"

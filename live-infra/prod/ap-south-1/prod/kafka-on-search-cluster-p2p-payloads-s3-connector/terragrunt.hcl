...
inputs = {
  ...
  connector_name       = "s3-on-search-cluster-payload"
  cloudwatch_log_group = "s3-on-search-cluster-payload"
  name = "s3-on-search-cluster-payload"
  ...
  map_of_connector_configuration               = tomap({
    ...
    "tasks.max"                   = "1"
    "topics.regex"                = "on_search_cluster_p2p_payload"
